    ...
    <div class="layout">
        <div class="container">
             ...
             <div style="flex: 0 0 auto; text-align: center;">
                <img src="../objects_imgs/111_callbell/base0.jpg" 
                    alt="base0" 
                ...
                <p style="margin-top:8px; font-size:16px; color:#555;">base0</p>
                 ...
                 <div style="flex: 0 0 auto; text-align: center;">
                <img src="../objects_imgs/111_callbell/base1.jpg" 
                    alt="base1" 
                    style="width:100%; max-width:350px; border-radius:8px; box-shadow:0 2px 6px rgba(0,0,0,0.1);">
            ...
            <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px;">
             <div style="flex: 0 0 auto; text-align: center;">
                <img src="../objects_imgs/111_callbell/base2.jpg" 
                    alt="base2" 
                    style="width:100%; max-width:350px; border-radius:8px; box-shadow:0 2px 6px rgba(0,0,0,0.1);">
                <p style="margin-top:8px; font-size:16px; color:#555;">base2</p>
            </div>
                 <div style="flex: 0 0 auto; text-align: center;">
                <img src="../objects_imgs/111_callbell/base3.jpg" 
                    alt="base3" 
                    style="width:100%; max-width:350px; border-radius:8px; box-shadow:0 2px 6px rgba(0,0,0,0.1);">
            ...
            <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px;">
             <div style="flex: 0 0 auto; text-align: center;">
                <img src="../objects_imgs/111_callbell/base4.jpg" 
                    alt="base4" 
                    style="width:100%; max-width:350px; border-radius:8px; box-shadow:0 2px 6px rgba(0,0,0,0.1);">
                <p style="margin-top:8px; font-size:16px; color:#555;">base4</p>
            </div>
                 <div style="flex: 0 0 auto; text-align: center;">
                <img src="../objects_imgs/111_callbell/base5.jpg" 
                    alt="base5" 
                    style="width:100%; max-width:350px; border-radius:8px; box-shadow:0 2px 6px rgba(0,0,0,0.1);">
