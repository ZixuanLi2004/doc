...
11. **dual_arm**: Boolean indicating whether the URDF is dual-arm (true for ALOHA) or single-arm (false for Franka).
...
![Coordinate System Visualization](./images/new_embodiment.png)
